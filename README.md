...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/mawady/awesome-cv) ⭐ 174 | 🐛 0 | 📅 2026-08-19
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,786 | 🐛 2,780 | 🌐 C++ | 📅 2026-09-10: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 15,005 | 🐛 1,835 | 🌐 Python | 📅 2026-09-10: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,808 | 🐛 155 | 🌐 Python | 📅 2026-09-10: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,351 | 🐛 153 | 🌐 Python | 📅 2026-09-10: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,582 | 🐛 947 | 🌐 Python | 📅 2026-09-09: Collection of algorithms for image processing · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,867 | 🐛 226 | 🌐 Rust | 📅 2026-08-28: Encoding and decoding images in Rust · ✅ active
...
* [ImageProc](https://github.com/image-rs/imageproc) ⭐ 976 | 🐛 87 | 🌐 Rust | 📅 2026-08-29: Image processing operations built on the image crate · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,263 | 🐛 240 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,985 | 🐛 31 | 🌐 Python | 📅 2026-09-01 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,135 | 🐛 59 | 🌐 Python | 📅 2026-09-09 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,898 | 🐛 541 | 🌐 C++ | 📅 2026-09-10 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
...
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,432 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,917 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,330 | 🐛 1,088 | 🌐 Python | 📅 2026-09-10 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,987 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,133 | 🐛 269 | 🌐 Jupyter Notebook | 📅 2026-09-09 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,735 | 🐛 981 | 🌐 Jupyter Notebook | 📅 2026-09-07 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,500 | 🐛 141 | 🌐 Python | 📅 2026-09-05 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,073 | 🐛 1,330 | 🌐 Python | 📅 2026-09-01 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,799 | 🐛 1,241 | 🌐 C++ | 📅 2026-09-10 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,788 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,731 | 🐛 82 | 🌐 Python | 📅 2026-09-10 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,351 | 🐛 153 | 🌐 Python | 📅 2026-09-10 `[GenLib]` Open source differentiable computer vision library.
...
* [pyod](https://github.com/yzhao062/pyod) ⭐ 9,997 | 🐛 244 | 🌐 Python | 📅 2026-09-08 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,946 | 🐛 869 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,881 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
* [U-2-Net](https://github.com/xuebinqin/U-2-Net) ⭐ 9,857 | 🐛 249 | 🌐 Python | 📅 2024-06-26 `[ObjDet]` U²-Net: nested U-structure architecture for salient object detection.
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,517 | 🐛 123 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,672 | 🐛 525 | 🌐 Python | 📅 2026-09-10 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
...
* [SAHI](https://github.com/obss/sahi) ⭐ 5,497 | 🐛 4 | 🌐 Python | 📅 2026-09-10 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,783 | 🐛 182 | 🌐 Python | 📅 2026-09-09 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,206 | 🐛 0 | 🌐 C++ | 📅 2026-09-10 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,072 | 🐛 174 | 🌐 Python | 📅 2026-09-07 `[EyeTrk]` Library for running psychology and neuroscience experiments.
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,908 | 🐛 30 | 🌐 Python | 📅 2026-08-23 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [WeightWatcher](https://github.com/CalculatedContent/WeightWatcher) ⭐ 1,775 | 🐛 120 | 🌐 Python | 📅 2026-05-11 `[XAI]` Open-source diagnostic tool for analyzing deep neural networks without needing training or test data.
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,654 | 🐛 347 | 🌐 C++ | 📅 2026-09-09 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
