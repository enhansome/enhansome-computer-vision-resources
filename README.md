...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,913 | 🐛 2,770 | 🌐 C++ | 📅 2026-09-21: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 15,032 | 🐛 1,837 | 🌐 Python | 📅 2026-09-21: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,833 | 🐛 135 | 🌐 Python | 📅 2026-09-21: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,371 | 🐛 176 | 🌐 Python | 📅 2026-09-21: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,594 | 🐛 954 | 🌐 Python | 📅 2026-09-21: Collection of algorithms for image processing · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,879 | 🐛 230 | 🌐 Rust | 📅 2026-09-15: Encoding and decoding images in Rust · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,932 | 🐛 252 | 🌐 Python | 📅 2026-09-16 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 58,062 | 🐛 31 | 🌐 Python | 📅 2026-09-16 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,162 | 🐛 50 | 🌐 Python | 📅 2026-09-18 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 37,026 | 🐛 522 | 🌐 C++ | 📅 2026-09-18 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,719 | 🐛 591 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,461 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,947 | 🐛 1,963 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,356 | 🐛 1,086 | 🌐 Python | 📅 2026-09-21 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,016 | 🐛 531 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,184 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2026-09-21 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,770 | 🐛 989 | 🌐 Jupyter Notebook | 📅 2026-09-20 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,515 | 🐛 142 | 🌐 Python | 📅 2026-09-20 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,097 | 🐛 1,342 | 🌐 Python | 📅 2026-09-01 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,852 | 🐛 1,204 | 🌐 C++ | 📅 2026-09-21 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,979 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,800 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
...
* [kornia](https://github.com/kornia/kornia) ⭐ 11,371 | 🐛 176 | 🌐 Python | 📅 2026-09-21 `[GenLib]` Open source differentiable computer vision library.
...
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,243 | 🐛 806 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,954 | 🐛 870 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,887 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
* [U-2-Net](https://github.com/xuebinqin/U-2-Net) ⭐ 9,864 | 🐛 249 | 🌐 Python | 📅 2024-06-26 `[ObjDet]` U²-Net: nested U-structure architecture for salient object detection.
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,529 | 🐛 124 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,393 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,700 | 🐛 519 | 🌐 Python | 📅 2026-09-21 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
...
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,390 | 🐛 21 | 🌐 Python | 📅 2026-07-13 `[OCR]` A Python wrapper for Google's Tesseract OCR engine.
...
* [SAHI](https://github.com/obss/sahi) ⭐ 5,511 | 🐛 3 | 🌐 Python | 📅 2026-09-17 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [mmtracking](https://github.com/open-mmlab/mmtracking) ⭐ 3,902 | 🐛 278 | 🌐 Python | 📅 2023-09-19 `[ObjTrk]` OpenMMLab's video perception toolbox for object detection and tracking.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,213 | 🐛 0 | 🌐 C++ | 📅 2026-09-21 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,083 | 🐛 172 | 🌐 Python | 📅 2026-09-21 `[EyeTrk]` Library for running psychology and neuroscience experiments.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,658 | 🐛 356 | 🌐 C++ | 📅 2026-09-19 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
