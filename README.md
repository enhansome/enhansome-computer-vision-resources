...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/mawady/awesome-cv) ⭐ 168 | 🐛 0 | 📅 2026-08-06
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,402 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-13: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,911 | 🐛 1,849 | 🌐 Python | 📅 2026-08-12: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,750 | 🐛 156 | 🌐 Python | 📅 2026-08-13: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,315 | 🐛 75 | 🌐 Python | 📅 2026-08-11: Open source differentiable computer vision library for PyTorch · ✅ active
...
* [mmcv](https://github.com/open-mmlab/mmcv) ⭐ 6,466 | 🐛 458 | 🌐 Python | 📅 2026-01-29: OpenMMLab foundational library for computer vision research · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,850 | 🐛 225 | 🌐 Rust | 📅 2026-08-07: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,880 | 🐛 50 | 🌐 Rust | 📅 2026-07-02: Rust/WebAssembly image processing library · ⚠️ legacy
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 87,560 | 🐛 228 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,863 | 🐛 31 | 🌐 Python | 📅 2026-08-02 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,062 | 🐛 61 | 🌐 Python | 📅 2026-08-11 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,604 | 🐛 550 | 🌐 C++ | 📅 2026-08-12 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,664 | 🐛 586 | 🌐 Python | 📅 2026-07-24 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,361 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,873 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,287 | 🐛 1,065 | 🌐 Python | 📅 2026-08-09 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,902 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,116 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-07-30 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,684 | 🐛 1,017 | 🌐 Jupyter Notebook | 📅 2026-08-11 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,482 | 🐛 141 | 🌐 Python | 📅 2026-08-02 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,006 | 🐛 1,306 | 🌐 Python | 📅 2026-07-31 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,691 | 🐛 1,216 | 🌐 C++ | 📅 2026-08-13 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
* [darknet](https://github.com/AlexeyAB/darknet) ⭐ 22,151 | 🐛 5,438 | 🌐 C | 📅 2025-12-15 `[ObjDet]` YOLOv4 / Scaled-YOLOv4 / YOLOv3 / YOLOv2 implementations.
* [Bringing-Old-Photos-Back-to-Life](https://github.com/microsoft/Bringing-Old-Photos-Back-to-Life) ⭐ 15,703 | 🐛 109 | 🌐 Python | 📅 2023-10-26 `[ImgEnh]` Microsoft's CVPR 2020 oral paper implementation for restoring old and damaged photos.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,951 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,690 | 🐛 81 | 🌐 Python | 📅 2026-08-13 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,315 | 🐛 75 | 🌐 Python | 📅 2026-08-11 `[GenLib]` Open source differentiable computer vision library.
* [DALLE2-pytorch](https://github.com/lucidrains/DALLE2-pytorch) ⭐ 11,302 | 🐛 74 | 🌐 Python | 📅 2024-05-11 `[TexImg]` PyTorch implementation of OpenAI's DALL-E 2 text-to-image synthesis network.
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,207 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
* [pyod](https://github.com/yzhao062/pyod) ⭐ 9,959 | 🐛 236 | 🌐 Python | 📅 2026-08-02 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,913 | 🐛 867 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
...
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,486 | 🐛 122 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,373 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,594 | 🐛 538 | 🌐 Python | 📅 2026-08-10 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
* [imagen-pytorch](https://github.com/lucidrains/imagen-pytorch) ⭐ 8,419 | 🐛 103 | 🌐 Python | 📅 2024-10-07 `[TexImg]` PyTorch implementation of Google's Imagen text-to-image neural network.
* [pytorch-cnn-visualizations](https://github.com/utkuozbulak/pytorch-cnn-visualizations) ⭐ 8,226 | 🐛 2 | 🌐 Python | 📅 2025-01-01 `[XAI]` PyTorch implementations of convolutional neural network visualization techniques.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,685 | 🐛 66 | 🌐 Python | 📅 2026-08-11 `[XAI]` PyTorch team's library for model interpretability and understanding.
...
* [SAHI](https://github.com/obss/sahi) ⭐ 5,459 | 🐛 4 | 🌐 Python | 📅 2026-08-07 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,773 | 🐛 187 | 🌐 Python | 📅 2026-08-01 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
...
* [mmclassification](https://github.com/open-mmlab/mmclassification) ⭐ 3,848 | 🐛 272 | 🌐 Python | 📅 2024-11-01 `[ObjCls]` OpenMMLab's image classification toolbox and benchmark.
* [TensorWatch](https://github.com/microsoft/tensorwatch) ⭐ 3,470 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2026-03-30 `[XAI]` Microsoft's debugging, monitoring, and visualization tool for Python ML and data science.
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,189 | 🐛 0 | 🌐 C++ | 📅 2026-08-13 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [alibi-detect](https://github.com/SeldonIO/alibi-detect) ⭐ 2,546 | 🐛 143 | 🌐 Jupyter Notebook | 📅 2025-12-11 `[NvlDet]` Algorithms for outlier, adversarial, and drift detection.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,063 | 🐛 185 | 🌐 Python | 📅 2026-08-10 `[EyeTrk]` Library for running psychology and neuroscience experiments.
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,891 | 🐛 34 | 🌐 Python | 📅 2026-04-14 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,642 | 🐛 334 | 🌐 C++ | 📅 2026-08-11 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [aesthetics](https://github.com/ylogx/aesthetics) ⭐ 231 | 🐛 8 | 🌐 Python | 📅 2023-07-06 `[AesAss]` Image aesthetics toolkit using Fisher Vectors.
...
* [the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,617 | 🐛 3 | 📅 2026-07-22, Curated list of tutorials, papers, projects, communities and more relating to PyTorch
