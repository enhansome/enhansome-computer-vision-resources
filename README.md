...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,615 | 🐛 2,757 | 🌐 C++ | 📅 2026-08-27: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,958 | 🐛 1,846 | 🌐 Python | 📅 2026-08-26: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,776 | 🐛 171 | 🌐 Python | 📅 2026-08-27: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,329 | 🐛 113 | 🌐 Python | 📅 2026-08-27: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,578 | 🐛 945 | 🌐 Python | 📅 2026-08-26: Collection of algorithms for image processing · ✅ active
* [mmcv](https://github.com/open-mmlab/mmcv) ⭐ 6,470 | 🐛 460 | 🌐 Python | 📅 2026-01-29: OpenMMLab foundational library for computer vision research · ✅ active
* [imutils](https://github.com/PyImageSearch/imutils) ⭐ 4,589 | 🐛 163 | 🌐 Python | 📅 2024-06-24: Convenience functions for basic image processing operations · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,862 | 🐛 224 | 🌐 Rust | 📅 2026-08-26: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,884 | 🐛 51 | 🌐 Rust | 📅 2026-07-02: Rust/WebAssembly image processing library · ⚠️ legacy
* [OpenCV-Rust](https://github.com/twistedfall/opencv-rust) ⭐ 2,483 | 🐛 17 | 🌐 Rust | 📅 2026-07-31: Rust bindings for OpenCV 3.4, 4.x, and 5.x · ✅ active
* [ImageProc](https://github.com/image-rs/imageproc) ⭐ 975 | 🐛 86 | 🌐 Rust | 📅 2026-07-31: Image processing operations built on the image crate · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,338 | 🐛 234 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,935 | 🐛 31 | 🌐 Python | 📅 2026-08-24 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,102 | 🐛 56 | 🌐 Python | 📅 2026-08-26 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,741 | 🐛 550 | 🌐 C++ | 📅 2026-08-27 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,690 | 🐛 585 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,417 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,894 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,310 | 🐛 1,081 | 🌐 Python | 📅 2026-08-25 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,943 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,126 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-08-15 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,706 | 🐛 1,002 | 🌐 Jupyter Notebook | 📅 2026-08-24 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,487 | 🐛 142 | 🌐 Python | 📅 2026-08-02 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,037 | 🐛 1,310 | 🌐 Python | 📅 2026-08-24 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,755 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-25 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
* [darknet](https://github.com/AlexeyAB/darknet) ⭐ 22,152 | 🐛 5,438 | 🌐 C | 📅 2025-12-15 `[ObjDet]` YOLOv4 / Scaled-YOLOv4 / YOLOv3 / YOLOv2 implementations.
* [Bringing-Old-Photos-Back-to-Life](https://github.com/microsoft/Bringing-Old-Photos-Back-to-Life) ⭐ 15,704 | 🐛 109 | 🌐 Python | 📅 2023-10-26 `[ImgEnh]` Microsoft's CVPR 2020 oral paper implementation for restoring old and damaged photos.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,958 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,707 | 🐛 82 | 🌐 Python | 📅 2026-08-24 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,329 | 🐛 113 | 🌐 Python | 📅 2026-08-27 `[GenLib]` Open source differentiable computer vision library.
* [DALLE2-pytorch](https://github.com/lucidrains/DALLE2-pytorch) ⭐ 11,306 | 🐛 73 | 🌐 Python | 📅 2024-05-11 `[TexImg]` PyTorch implementation of OpenAI's DALL-E 2 text-to-image synthesis network.
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,223 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
* [pyod](https://github.com/yzhao062/pyod) ⭐ 9,977 | 🐛 233 | 🌐 Python | 📅 2026-08-19 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,931 | 🐛 869 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
...
* [U-2-Net](https://github.com/xuebinqin/U-2-Net) ⭐ 9,854 | 🐛 248 | 🌐 Python | 📅 2024-06-26 `[ObjDet]` U²-Net: nested U-structure architecture for salient object detection.
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,500 | 🐛 123 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,382 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,636 | 🐛 529 | 🌐 Python | 📅 2026-08-26 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
...
* [pytorch-cnn-visualizations](https://github.com/utkuozbulak/pytorch-cnn-visualizations) ⭐ 8,233 | 🐛 2 | 🌐 Python | 📅 2025-01-01 `[XAI]` PyTorch implementations of convolutional neural network visualization techniques.
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,383 | 🐛 21 | 🌐 Python | 📅 2026-07-13 `[OCR]` A Python wrapper for Google's Tesseract OCR engine.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,693 | 🐛 64 | 🌐 Python | 📅 2026-08-27 `[XAI]` PyTorch team's library for model interpretability and understanding.
* [imagededup](https://github.com/idealo/imagededup) ⭐ 5,667 | 🐛 38 | 🌐 Python | 📅 2025-08-15 `[CBIR]` Simple tool to find and remove duplicate images from datasets.
* [SAHI](https://github.com/obss/sahi) ⭐ 5,474 | 🐛 1 | 🌐 Python | 📅 2026-08-22 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,778 | 🐛 190 | 🌐 Python | 📅 2026-08-17 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
* [mmocr](https://github.com/open-mmlab/mmocr) ⭐ 4,752 | 🐛 194 | 🌐 Python | 📅 2024-11-27 `[OCR]` OpenMMLab's text detection, recognition and understanding toolbox.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,202 | 🐛 0 | 🌐 C++ | 📅 2026-08-27 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [FaceDetection-DSFD](https://github.com/Tencent/FaceDetection-DSFD) ⭐ 2,969 | 🐛 68 | 🌐 Python | 📅 2025-11-13 `[ObjDet]` Tencent's state-of-the-art face detector.
* [Alibi](https://github.com/SeldonIO/alibi) ⭐ 2,644 | 🐛 159 | 🌐 Python | 📅 2025-10-17 `[XAI]` Algorithms for explaining machine learning models.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,068 | 🐛 168 | 🌐 Python | 📅 2026-08-26 `[EyeTrk]` Library for running psychology and neuroscience experiments.
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,905 | 🐛 30 | 🌐 Python | 📅 2026-08-23 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [WeightWatcher](https://github.com/CalculatedContent/WeightWatcher) ⭐ 1,772 | 🐛 120 | 🌐 Python | 📅 2026-05-11 `[XAI]` Open-source diagnostic tool for analyzing deep neural networks without needing training or test data.
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,648 | 🐛 341 | 🌐 C++ | 📅 2026-08-27 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,634 | 🐛 3 | 📅 2026-07-22, Curated list of tutorials, papers, projects, communities and more relating to PyTorch
...
* [awesome-Face\_Recognition](https://github.com/ChanChiChoi/awesome-Face_Recognition) ⭐ 4,754 | 🐛 10 | 📅 2023-02-09, Computer vision papers about faces.
...
* [benthecoder/yt-channels-DS-AI-ML-CS](https://github.com/benthecoder/yt-channels-DS-AI-ML-CS) ⭐ 1,622 | 🐛 1 | 📅 2026-07-19
