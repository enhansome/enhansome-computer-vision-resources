...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,958 | 🐛 2,769 | 🌐 C++ | 📅 2026-09-25: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 15,038 | 🐛 1,848 | 🌐 Python | 📅 2026-09-25: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,842 | 🐛 136 | 🌐 Python | 📅 2026-09-25: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,380 | 🐛 208 | 🌐 Python | 📅 2026-09-25: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,595 | 🐛 951 | 🌐 Python | 📅 2026-09-24: Collection of algorithms for image processing · ✅ active
* [mmcv](https://github.com/open-mmlab/mmcv) ⭐ 6,475 | 🐛 465 | 🌐 Python | 📅 2026-01-29: OpenMMLab foundational library for computer vision research · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,882 | 🐛 230 | 🌐 Rust | 📅 2026-09-15: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,894 | 🐛 49 | 🌐 Rust | 📅 2026-09-18: Rust/WebAssembly image processing library · ⚠️ legacy
...
* [ImageProc](https://github.com/image-rs/imageproc) ⭐ 980 | 🐛 88 | 🌐 Rust | 📅 2026-08-29: Image processing operations built on the image crate · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 90,200 | 🐛 252 | 🌐 Python | 📅 2026-09-16 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 58,083 | 🐛 31 | 🌐 Python | 📅 2026-09-16 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,172 | 🐛 41 | 🌐 Python | 📅 2026-09-24 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 37,075 | 🐛 507 | 🌐 C++ | 📅 2026-09-25 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,731 | 🐛 591 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,467 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,958 | 🐛 1,963 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,361 | 🐛 1,088 | 🌐 Python | 📅 2026-09-21 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,027 | 🐛 531 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,193 | 🐛 271 | 🌐 Jupyter Notebook | 📅 2026-09-21 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,784 | 🐛 981 | 🌐 Jupyter Notebook | 📅 2026-09-21 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,522 | 🐛 142 | 🌐 Python | 📅 2026-09-20 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,098 | 🐛 1,347 | 🌐 Python | 📅 2026-09-01 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,869 | 🐛 1,209 | 🌐 C++ | 📅 2026-09-24 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
* [darknet](https://github.com/AlexeyAB/darknet) ⭐ 22,147 | 🐛 5,446 | 🌐 C | 📅 2025-12-15 `[ObjDet]` YOLOv4 / Scaled-YOLOv4 / YOLOv3 / YOLOv2 implementations.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,981 | 🐛 161 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,804 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,745 | 🐛 83 | 🌐 Python | 📅 2026-09-21 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,380 | 🐛 208 | 🌐 Python | 📅 2026-09-25 `[GenLib]` Open source differentiable computer vision library.
...
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,245 | 🐛 806 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
* [pyod](https://github.com/yzhao062/pyod) ⭐ 10,011 | 🐛 241 | 🌐 Python | 📅 2026-09-17 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,961 | 🐛 870 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,890 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
...
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,534 | 🐛 124 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,396 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,707 | 🐛 523 | 🌐 Python | 📅 2026-09-22 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
* [imagen-pytorch](https://github.com/lucidrains/imagen-pytorch) ⭐ 8,429 | 🐛 105 | 🌐 Python | 📅 2024-10-07 `[TexImg]` PyTorch implementation of Google's Imagen text-to-image neural network.
* [pytorch-cnn-visualizations](https://github.com/utkuozbulak/pytorch-cnn-visualizations) ⭐ 8,235 | 🐛 2 | 🌐 Python | 📅 2025-01-01 `[XAI]` PyTorch implementations of convolutional neural network visualization techniques.
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,392 | 🐛 21 | 🌐 Python | 📅 2026-07-13 `[OCR]` A Python wrapper for Google's Tesseract OCR engine.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,705 | 🐛 77 | 🌐 Python | 📅 2026-09-24 `[XAI]` PyTorch team's library for model interpretability and understanding.
* [imagededup](https://github.com/idealo/imagededup) ⭐ 5,671 | 🐛 39 | 🌐 Python | 📅 2025-08-15 `[CBIR]` Simple tool to find and remove duplicate images from datasets.
* [SAHI](https://github.com/obss/sahi) ⭐ 5,515 | 🐛 2 | 🌐 Python | 📅 2026-09-25 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,787 | 🐛 186 | 🌐 Python | 📅 2026-09-09 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
...
* [mmtracking](https://github.com/open-mmlab/mmtracking) ⭐ 3,903 | 🐛 278 | 🌐 Python | 📅 2023-09-19 `[ObjTrk]` OpenMMLab's video perception toolbox for object detection and tracking.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,213 | 🐛 0 | 🌐 C++ | 📅 2026-09-25 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [Alibi](https://github.com/SeldonIO/alibi) ⭐ 2,646 | 🐛 159 | 🌐 Python | 📅 2025-10-17 `[XAI]` Algorithms for explaining machine learning models.
* [alibi-detect](https://github.com/SeldonIO/alibi-detect) ⭐ 2,548 | 🐛 147 | 🌐 Jupyter Notebook | 📅 2025-12-11 `[NvlDet]` Algorithms for outlier, adversarial, and drift detection.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,085 | 🐛 169 | 🌐 Python | 📅 2026-09-25 `[EyeTrk]` Library for running psychology and neuroscience experiments.
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,910 | 🐛 30 | 🌐 Python | 📅 2026-08-23 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,660 | 🐛 366 | 🌐 C++ | 📅 2026-09-25 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,649 | 🐛 3 | 📅 2026-09-23, Curated list of tutorials, papers, projects, communities and more relating to PyTorch
...
* [benthecoder/yt-channels-DS-AI-ML-CS](https://github.com/benthecoder/yt-channels-DS-AI-ML-CS) ⭐ 1,630 | 🐛 1 | 📅 2026-07-19
