...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,970 | 🐛 2,771 | 🌐 C++ | 📅 2026-09-25: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 15,046 | 🐛 1,845 | 🌐 Python | 📅 2026-09-26: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,846 | 🐛 139 | 🌐 Python | 📅 2026-09-26: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,383 | 🐛 204 | 🌐 Python | 📅 2026-09-26: Open source differentiable computer vision library for PyTorch · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 90,238 | 🐛 252 | 🌐 Python | 📅 2026-09-16 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 58,088 | 🐛 31 | 🌐 Python | 📅 2026-09-16 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,171 | 🐛 40 | 🌐 Python | 📅 2026-09-25 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 37,082 | 🐛 507 | 🌐 C++ | 📅 2026-09-25 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,734 | 🐛 591 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,466 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
...
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,362 | 🐛 1,088 | 🌐 Python | 📅 2026-09-21 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,030 | 🐛 531 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,197 | 🐛 272 | 🌐 Jupyter Notebook | 📅 2026-09-21 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,784 | 🐛 981 | 🌐 Jupyter Notebook | 📅 2026-09-25 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,523 | 🐛 142 | 🌐 Python | 📅 2026-09-20 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,099 | 🐛 1,348 | 🌐 Python | 📅 2026-09-01 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,873 | 🐛 1,209 | 🌐 C++ | 📅 2026-09-24 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
...
* [Bringing-Old-Photos-Back-to-Life](https://github.com/microsoft/Bringing-Old-Photos-Back-to-Life) ⭐ 15,721 | 🐛 109 | 🌐 Python | 📅 2023-10-26 `[ImgEnh]` Microsoft's CVPR 2020 oral paper implementation for restoring old and damaged photos.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,982 | 🐛 161 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,805 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
...
* [kornia](https://github.com/kornia/kornia) ⭐ 11,383 | 🐛 204 | 🌐 Python | 📅 2026-09-26 `[GenLib]` Open source differentiable computer vision library.
...
* [pyod](https://github.com/yzhao062/pyod) ⭐ 10,013 | 🐛 241 | 🌐 Python | 📅 2026-09-17 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
...
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,889 | 🐛 113 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
...
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,536 | 🐛 124 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,710 | 🐛 521 | 🌐 Python | 📅 2026-09-26 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,706 | 🐛 79 | 🌐 Python | 📅 2026-09-24 `[XAI]` PyTorch team's library for model interpretability and understanding.
* [imagededup](https://github.com/idealo/imagededup) ⭐ 5,672 | 🐛 39 | 🌐 Python | 📅 2025-08-15 `[CBIR]` Simple tool to find and remove duplicate images from datasets.
* [SAHI](https://github.com/obss/sahi) ⭐ 5,515 | 🐛 4 | 🌐 Python | 📅 2026-09-26 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,212 | 🐛 0 | 🌐 C++ | 📅 2026-09-26 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,086 | 🐛 168 | 🌐 Python | 📅 2026-09-25 `[EyeTrk]` Library for running psychology and neuroscience experiments.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,660 | 🐛 367 | 🌐 C++ | 📅 2026-09-26 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [Random-Erasing](https://github.com/zhunzhong07/Random-Erasing) ⭐ 733 | 🐛 10 | 🌐 Python | 📅 2023-11-08 `[DatAug]` Random erasing data augmentation implemented in PyTorch.
