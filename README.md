...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,588 | 🐛 2,757 | 🌐 C++ | 📅 2026-08-25: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,950 | 🐛 1,845 | 🌐 Python | 📅 2026-08-25: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,775 | 🐛 170 | 🌐 Python | 📅 2026-08-24: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,324 | 🐛 99 | 🌐 Python | 📅 2026-08-24: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,576 | 🐛 946 | 🌐 Python | 📅 2026-08-17: Collection of algorithms for image processing · ✅ active
...
* [imutils](https://github.com/PyImageSearch/imutils) ⭐ 4,590 | 🐛 163 | 🌐 Python | 📅 2024-06-24: Convenience functions for basic image processing operations · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,860 | 🐛 225 | 🌐 Rust | 📅 2026-08-07: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,879 | 🐛 50 | 🌐 Rust | 📅 2026-07-02: Rust/WebAssembly image processing library · ⚠️ legacy
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,244 | 🐛 232 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
...
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,088 | 🐛 61 | 🌐 Python | 📅 2026-08-24 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,715 | 🐛 550 | 🌐 C++ | 📅 2026-08-25 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
...
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,396 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,889 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,306 | 🐛 1,085 | 🌐 Python | 📅 2026-08-09 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,935 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,123 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-08-15 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,699 | 🐛 1,009 | 🌐 Jupyter Notebook | 📅 2026-08-24 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
...
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,031 | 🐛 1,310 | 🌐 Python | 📅 2026-08-24 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,740 | 🐛 1,229 | 🌐 C++ | 📅 2026-08-25 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
...
* [kornia](https://github.com/kornia/kornia) ⭐ 11,324 | 🐛 99 | 🌐 Python | 📅 2026-08-24 `[GenLib]` Open source differentiable computer vision library.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,926 | 🐛 869 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
...
* [U-2-Net](https://github.com/xuebinqin/U-2-Net) ⭐ 9,853 | 🐛 248 | 🌐 Python | 📅 2024-06-26 `[ObjDet]` U²-Net: nested U-structure architecture for salient object detection.
...
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,379 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,630 | 🐛 531 | 🌐 Python | 📅 2026-08-23 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
...
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,382 | 🐛 21 | 🌐 Python | 📅 2026-07-13 `[OCR]` A Python wrapper for Google's Tesseract OCR engine.
...
* [SAHI](https://github.com/obss/sahi) ⭐ 5,472 | 🐛 1 | 🌐 Python | 📅 2026-08-22 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,199 | 🐛 0 | 🌐 C++ | 📅 2026-08-25 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,068 | 🐛 182 | 🌐 Python | 📅 2026-08-24 `[EyeTrk]` Library for running psychology and neuroscience experiments.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,647 | 🐛 341 | 🌐 C++ | 📅 2026-08-25 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,632 | 🐛 3 | 📅 2026-07-22, Curated list of tutorials, papers, projects, communities and more relating to PyTorch
