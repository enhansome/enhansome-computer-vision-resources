...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,619 | 🐛 2,751 | 🌐 C++ | 📅 2026-08-27: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,960 | 🐛 1,844 | 🌐 Python | 📅 2026-08-27: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,777 | 🐛 176 | 🌐 Python | 📅 2026-08-27: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,330 | 🐛 114 | 🌐 Python | 📅 2026-08-27: Open source differentiable computer vision library for PyTorch · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,862 | 🐛 225 | 🌐 Rust | 📅 2026-08-26: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,885 | 🐛 50 | 🌐 Rust | 📅 2026-08-27: Rust/WebAssembly image processing library · ⚠️ legacy
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,354 | 🐛 234 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,937 | 🐛 31 | 🌐 Python | 📅 2026-08-24 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,103 | 🐛 54 | 🌐 Python | 📅 2026-08-27 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,745 | 🐛 550 | 🌐 C++ | 📅 2026-08-27 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,691 | 🐛 585 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,418 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
...
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,311 | 🐛 1,080 | 🌐 Python | 📅 2026-08-25 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
...
* [SHAP](https://github.com/shap/shap) ⭐ 25,706 | 🐛 1,005 | 🌐 Jupyter Notebook | 📅 2026-08-24 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
...
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,040 | 🐛 1,311 | 🌐 Python | 📅 2026-08-24 `[GenLib]` Graph Neural Network Library for PyTorch.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,959 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
...
* [kornia](https://github.com/kornia/kornia) ⭐ 11,330 | 🐛 114 | 🌐 Python | 📅 2026-08-27 `[GenLib]` Open source differentiable computer vision library.
...
* [pyod](https://github.com/yzhao062/pyod) ⭐ 9,977 | 🐛 234 | 🌐 Python | 📅 2026-08-19 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
...
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,501 | 🐛 123 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,383 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
...
* [imagededup](https://github.com/idealo/imagededup) ⭐ 5,668 | 🐛 38 | 🌐 Python | 📅 2025-08-15 `[CBIR]` Simple tool to find and remove duplicate images from datasets.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,203 | 🐛 0 | 🌐 C++ | 📅 2026-08-27 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
