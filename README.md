...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/mawady/awesome-cv) ⭐ 170 | 🐛 0 | 📅 2026-08-19
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,516 | 🐛 2,746 | 🌐 C++ | 📅 2026-08-20: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,936 | 🐛 1,844 | 🌐 Python | 📅 2026-08-20: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,764 | 🐛 159 | 🌐 Python | 📅 2026-08-20: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,318 | 🐛 88 | 🌐 Python | 📅 2026-08-18: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,572 | 🐛 940 | 🌐 Python | 📅 2026-08-17: Collection of algorithms for image processing · ✅ active
* [mmcv](https://github.com/open-mmlab/mmcv) ⭐ 6,466 | 🐛 459 | 🌐 Python | 📅 2026-01-29: OpenMMLab foundational library for computer vision research · ✅ active
* [imutils](https://github.com/PyImageSearch/imutils) ⭐ 4,592 | 🐛 163 | 🌐 Python | 📅 2024-06-24: Convenience functions for basic image processing operations · ✅ active
...
* [Mahotas](https://github.com/luispedro/mahotas) ⭐ 888 | 🐛 24 | 🌐 Python | 📅 2026-06-12: Fast computer vision algorithms in Python · ⚠️ legacy
...
* [Image](https://github.com/image-rs/image) ⭐ 5,854 | 🐛 225 | 🌐 Rust | 📅 2026-08-07: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,878 | 🐛 50 | 🌐 Rust | 📅 2026-07-02: Rust/WebAssembly image processing library · ⚠️ legacy
* [OpenCV-Rust](https://github.com/twistedfall/opencv-rust) ⭐ 2,481 | 🐛 17 | 🌐 Rust | 📅 2026-07-31: Rust bindings for OpenCV 3.4, 4.x, and 5.x · ✅ active
* [ImageProc](https://github.com/image-rs/imageproc) ⭐ 976 | 🐛 86 | 🌐 Rust | 📅 2026-07-31: Image processing operations built on the image crate · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 87,973 | 🐛 235 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,908 | 🐛 31 | 🌐 Python | 📅 2026-08-16 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,075 | 🐛 62 | 🌐 Python | 📅 2026-08-11 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,670 | 🐛 543 | 🌐 C++ | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,677 | 🐛 587 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,374 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,885 | 🐛 1,960 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,296 | 🐛 1,081 | 🌐 Python | 📅 2026-08-09 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,922 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,116 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-08-15 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,693 | 🐛 1,010 | 🌐 Jupyter Notebook | 📅 2026-08-11 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
...
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,019 | 🐛 1,309 | 🌐 Python | 📅 2026-08-17 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,720 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-18 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
* [darknet](https://github.com/AlexeyAB/darknet) ⭐ 22,156 | 🐛 5,438 | 🌐 C | 📅 2025-12-15 `[ObjDet]` YOLOv4 / Scaled-YOLOv4 / YOLOv3 / YOLOv2 implementations.
* [Bringing-Old-Photos-Back-to-Life](https://github.com/microsoft/Bringing-Old-Photos-Back-to-Life) ⭐ 15,701 | 🐛 109 | 🌐 Python | 📅 2023-10-26 `[ImgEnh]` Microsoft's CVPR 2020 oral paper implementation for restoring old and damaged photos.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,954 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,781 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,701 | 🐛 81 | 🌐 Python | 📅 2026-08-17 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,318 | 🐛 88 | 🌐 Python | 📅 2026-08-18 `[GenLib]` Open source differentiable computer vision library.
* [DALLE2-pytorch](https://github.com/lucidrains/DALLE2-pytorch) ⭐ 11,307 | 🐛 73 | 🌐 Python | 📅 2024-05-11 `[TexImg]` PyTorch implementation of OpenAI's DALL-E 2 text-to-image synthesis network.
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,214 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
* [pyod](https://github.com/yzhao062/pyod) ⭐ 9,974 | 🐛 232 | 🌐 Python | 📅 2026-08-19 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,922 | 🐛 869 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,877 | 🐛 112 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
* [U-2-Net](https://github.com/xuebinqin/U-2-Net) ⭐ 9,849 | 🐛 248 | 🌐 Python | 📅 2024-06-26 `[ObjDet]` U²-Net: nested U-structure architecture for salient object detection.
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,490 | 🐛 123 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,376 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,616 | 🐛 525 | 🌐 Python | 📅 2026-08-19 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
* [imagen-pytorch](https://github.com/lucidrains/imagen-pytorch) ⭐ 8,422 | 🐛 103 | 🌐 Python | 📅 2024-10-07 `[TexImg]` PyTorch implementation of Google's Imagen text-to-image neural network.
* [pytorch-cnn-visualizations](https://github.com/utkuozbulak/pytorch-cnn-visualizations) ⭐ 8,230 | 🐛 2 | 🌐 Python | 📅 2025-01-01 `[XAI]` PyTorch implementations of convolutional neural network visualization techniques.
* [pytesseract](https://github.com/madmaze/pytesseract) ⭐ 6,378 | 🐛 21 | 🌐 Python | 📅 2026-07-13 `[OCR]` A Python wrapper for Google's Tesseract OCR engine.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,688 | 🐛 66 | 🌐 Python | 📅 2026-08-19 `[XAI]` PyTorch team's library for model interpretability and understanding.
* [imagededup](https://github.com/idealo/imagededup) ⭐ 5,664 | 🐛 38 | 🌐 Python | 📅 2025-08-15 `[CBIR]` Simple tool to find and remove duplicate images from datasets.
* [SAHI](https://github.com/obss/sahi) ⭐ 5,471 | 🐛 3 | 🌐 Python | 📅 2026-08-20 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
* [Object-Detection-Metrics](https://github.com/rafaelpadilla/Object-Detection-Metrics) ⭐ 5,100 | 🐛 1 | 🌐 Python | 📅 2026-07-16 `[ObjDet]` The most popular metrics used to evaluate object detection algorithms.
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,776 | 🐛 187 | 🌐 Python | 📅 2026-08-17 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
* [mmocr](https://github.com/open-mmlab/mmocr) ⭐ 4,749 | 🐛 194 | 🌐 Python | 📅 2024-11-27 `[OCR]` OpenMMLab's text detection, recognition and understanding toolbox.
* [mmtracking](https://github.com/open-mmlab/mmtracking) ⭐ 3,895 | 🐛 277 | 🌐 Python | 📅 2023-09-19 `[ObjTrk]` OpenMMLab's video perception toolbox for object detection and tracking.
* [mmclassification](https://github.com/open-mmlab/mmclassification) ⭐ 3,849 | 🐛 273 | 🌐 Python | 📅 2024-11-01 `[ObjCls]` OpenMMLab's image classification toolbox and benchmark.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,195 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [alibi-detect](https://github.com/SeldonIO/alibi-detect) ⭐ 2,547 | 🐛 146 | 🌐 Jupyter Notebook | 📅 2025-12-11 `[NvlDet]` Algorithms for outlier, adversarial, and drift detection.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,069 | 🐛 183 | 🌐 Python | 📅 2026-08-19 `[EyeTrk]` Library for running psychology and neuroscience experiments.
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,903 | 🐛 34 | 🌐 Python | 📅 2026-04-14 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [WeightWatcher](https://github.com/CalculatedContent/WeightWatcher) ⭐ 1,773 | 🐛 120 | 🌐 Python | 📅 2026-05-11 `[XAI]` Open-source diagnostic tool for analyzing deep neural networks without needing training or test data.
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,645 | 🐛 332 | 🌐 C++ | 📅 2026-08-20 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
* [iNNvestigate](https://github.com/albermax/innvestigate) ⭐ 1,307 | 🐛 61 | 🌐 Python | 📅 2025-04-11 `[XAI]` TensorFlow toolbox for investigating neural network predictions.
...
* [the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,626 | 🐛 3 | 📅 2026-07-22, Curated list of tutorials, papers, projects, communities and more relating to PyTorch
...
* [awesome-Face\_Recognition](https://github.com/ChanChiChoi/awesome-Face_Recognition) ⭐ 4,757 | 🐛 10 | 📅 2023-02-09, Computer vision papers about faces.
...
* [benthecoder/yt-channels-DS-AI-ML-CS](https://github.com/benthecoder/yt-channels-DS-AI-ML-CS) ⭐ 1,619 | 🐛 1 | 📅 2026-07-19
