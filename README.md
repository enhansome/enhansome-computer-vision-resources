...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,555 | 🐛 2,753 | 🌐 C++ | 📅 2026-08-22: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,946 | 🐛 1,844 | 🌐 Python | 📅 2026-08-23: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,773 | 🐛 160 | 🌐 Python | 📅 2026-08-22: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,324 | 🐛 96 | 🌐 Python | 📅 2026-08-21: Open source differentiable computer vision library for PyTorch · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,858 | 🐛 225 | 🌐 Rust | 📅 2026-08-07: Encoding and decoding images in Rust · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 88,138 | 🐛 235 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,920 | 🐛 33 | 🌐 Python | 📅 2026-08-20 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,081 | 🐛 61 | 🌐 Python | 📅 2026-08-21 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,691 | 🐛 550 | 🌐 C++ | 📅 2026-08-21 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,685 | 🐛 587 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,376 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
...
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,300 | 🐛 1,084 | 🌐 Python | 📅 2026-08-09 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,931 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,119 | 🐛 267 | 🌐 Jupyter Notebook | 📅 2026-08-15 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,697 | 🐛 1,010 | 🌐 Jupyter Notebook | 📅 2026-08-11 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,486 | 🐛 142 | 🌐 Python | 📅 2026-08-02 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,024 | 🐛 1,310 | 🌐 Python | 📅 2026-08-17 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,731 | 🐛 1,233 | 🌐 C++ | 📅 2026-08-18 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
...
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,782 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,703 | 🐛 82 | 🌐 Python | 📅 2026-08-17 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,324 | 🐛 96 | 🌐 Python | 📅 2026-08-21 `[GenLib]` Open source differentiable computer vision library.
...
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,219 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
* [pyod](https://github.com/yzhao062/pyod) ⭐ 9,975 | 🐛 232 | 🌐 Python | 📅 2026-08-19 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,924 | 🐛 869 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,879 | 🐛 112 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
...
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,377 | 🐛 29 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,625 | 🐛 529 | 🌐 Python | 📅 2026-08-20 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,689 | 🐛 64 | 🌐 Python | 📅 2026-08-22 `[XAI]` PyTorch team's library for model interpretability and understanding.
...
* [Object-Detection-Metrics](https://github.com/rafaelpadilla/Object-Detection-Metrics) ⭐ 5,099 | 🐛 0 | 🌐 Python | 📅 2026-08-21 `[ObjDet]` The most popular metrics used to evaluate object detection algorithms.
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,777 | 🐛 188 | 🌐 Python | 📅 2026-08-17 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,197 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [Alibi](https://github.com/SeldonIO/alibi) ⭐ 2,642 | 🐛 159 | 🌐 Python | 📅 2025-10-17 `[XAI]` Algorithms for explaining machine learning models.
...
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,904 | 🐛 34 | 🌐 Python | 📅 2026-04-14 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,646 | 🐛 334 | 🌐 C++ | 📅 2026-08-23 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
