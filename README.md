...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,826 | 🐛 2,768 | 🌐 C++ | 📅 2026-09-14: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 15,012 | 🐛 1,839 | 🌐 Python | 📅 2026-09-14: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,810 | 🐛 154 | 🌐 Python | 📅 2026-09-14: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,356 | 🐛 183 | 🌐 Python | 📅 2026-09-14: Open source differentiable computer vision library for PyTorch · ✅ active
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,587 | 🐛 951 | 🌐 Python | 📅 2026-09-09: Collection of algorithms for image processing · ✅ active
...
* [Image](https://github.com/image-rs/image) ⭐ 5,869 | 🐛 230 | 🌐 Rust | 📅 2026-08-28: Encoding and decoding images in Rust · ✅ active
* [Photon](https://github.com/silvia-odwyer/photon) ⭐ 3,892 | 🐛 49 | 🌐 Rust | 📅 2026-09-12: Rust/WebAssembly image processing library · ⚠️ legacy
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 89,504 | 🐛 243 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 58,008 | 🐛 32 | 🌐 Python | 📅 2026-09-14 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,140 | 🐛 62 | 🌐 Python | 📅 2026-09-12 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,938 | 🐛 537 | 🌐 C++ | 📅 2026-09-11 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,706 | 🐛 591 | 🌐 Python | 📅 2026-08-19 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,444 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
* [mmdetection](https://github.com/open-mmlab/mmdetection) ⭐ 32,922 | 🐛 1,962 | 🌐 Python | 📅 2024-08-21 `[ObjDet]` OpenMMLab's image detection toolbox and benchmark.
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,341 | 🐛 1,085 | 🌐 Python | 📅 2026-09-14 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,988 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
* [FastAI](https://github.com/fastai/fastai) ⭐ 28,133 | 🐛 270 | 🌐 Jupyter Notebook | 📅 2026-09-14 `[GenLib]` Library over PyTorch used for learning and practicing machine learning and deep learning.
* [SHAP](https://github.com/shap/shap) ⭐ 25,756 | 🐛 989 | 🌐 Jupyter Notebook | 📅 2026-09-13 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,503 | 🐛 141 | 🌐 Python | 📅 2026-09-05 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,078 | 🐛 1,334 | 🌐 Python | 📅 2026-09-01 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,813 | 🐛 1,235 | 🌐 C++ | 📅 2026-09-14 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
* [darknet](https://github.com/AlexeyAB/darknet) ⭐ 22,146 | 🐛 5,445 | 🌐 C | 📅 2025-12-15 `[ObjDet]` YOLOv4 / Scaled-YOLOv4 / YOLOv3 / YOLOv2 implementations.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,969 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
...
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,734 | 🐛 82 | 🌐 Python | 📅 2026-09-14 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,356 | 🐛 183 | 🌐 Python | 📅 2026-09-14 `[GenLib]` Open source differentiable computer vision library.
...
* [pyod](https://github.com/yzhao062/pyod) ⭐ 10,002 | 🐛 246 | 🌐 Python | 📅 2026-09-08 `[NvlDet]` Python toolbox for scalable outlier and anomaly detection.
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,948 | 🐛 870 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
...
* [RobustVideoMatting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,521 | 🐛 124 | 🌐 Python | 📅 2024-04-02 `[VidMat]` Robust video matting supporting PyTorch, TensorFlow, ONNX, and CoreML.
* [PaddleSeg](https://github.com/PaddlePaddle/PaddleSeg) ⭐ 9,388 | 🐛 28 | 🌐 Python | 📅 2026-02-05 `[ObjSeg]` Easy-to-use image segmentation library supporting semantic, interactive, panoptic, and 3D segmentation among others.
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,680 | 🐛 525 | 🌐 Python | 📅 2026-09-14 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
* [imagen-pytorch](https://github.com/lucidrains/imagen-pytorch) ⭐ 8,423 | 🐛 104 | 🌐 Python | 📅 2024-10-07 `[TexImg]` PyTorch implementation of Google's Imagen text-to-image neural network.
...
* [SAHI](https://github.com/obss/sahi) ⭐ 5,500 | 🐛 5 | 🌐 Python | 📅 2026-09-10 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,785 | 🐛 185 | 🌐 Python | 📅 2026-09-09 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
...
* [mmclassification](https://github.com/open-mmlab/mmclassification) ⭐ 3,854 | 🐛 273 | 🌐 Python | 📅 2024-11-01 `[ObjCls]` OpenMMLab's image classification toolbox and benchmark.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,207 | 🐛 0 | 🌐 C++ | 📅 2026-09-14 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,076 | 🐛 173 | 🌐 Python | 📅 2026-09-14 `[EyeTrk]` Library for running psychology and neuroscience experiments.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,654 | 🐛 350 | 🌐 C++ | 📅 2026-09-11 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [awesome-Face\_Recognition](https://github.com/ChanChiChoi/awesome-Face_Recognition) ⭐ 4,759 | 🐛 10 | 📅 2023-02-09, Computer vision papers about faces.
...
* [benthecoder/yt-channels-DS-AI-ML-CS](https://github.com/benthecoder/yt-channels-DS-AI-ML-CS) ⭐ 1,629 | 🐛 1 | 📅 2026-07-19
