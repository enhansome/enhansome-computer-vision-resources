...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,425 | 🐛 2,752 | 🌐 C++ | 📅 2026-08-14: Open Source Computer Vision Library · ✅ active
* [SciPy](https://github.com/scipy/scipy) ⭐ 14,917 | 🐛 1,854 | 🌐 Python | 📅 2026-08-13: Open-source software for mathematics, science, and engineering · ✅ active
* [Pillow](https://github.com/python-pillow/Pillow) ⭐ 13,752 | 🐛 156 | 🌐 Python | 📅 2026-08-13: The friendly PIL fork (Python Imaging Library) · ✅ active
* [kornia](https://github.com/kornia/kornia) ⭐ 11,316 | 🐛 77 | 🌐 Python | 📅 2026-08-11: Open source differentiable computer vision library for PyTorch · ✅ active
...
* [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) ⭐ 87,626 | 🐛 229 | 🌐 Python | 📅 2026-07-22 `[OCR]` Practical ultra-lightweight OCR system supporting 80+ languages with tools for training and deployment across server, mobile, and IoT devices.
* [yolov5](https://github.com/ultralytics/yolov5) ⭐ 57,872 | 🐛 31 | 🌐 Python | 📅 2026-08-02 `[ObjDet]` Ultralytics' YOLOv5 object detection framework.
* [PyTorch image models](https://github.com/rwightman/pytorch-image-models) ⭐ 37,065 | 🐛 61 | 🌐 Python | 📅 2026-08-11 `[ObjCls]` A wide collection of PyTorch image classification models, scripts, and pretrained weights.
* [MediaPipe](https://github.com/google/mediapipe) ⭐ 36,614 | 🐛 550 | 🌐 C++ | 📅 2026-08-12 `[ObjDet]` `[ObjSeg]` `[ObjTrk]` `[GenLib]` Google's cross-platform framework supporting face detection, hand/pose tracking, object detection, hair segmentation, and more.
* [detectron2](https://github.com/facebookresearch/detectron2) ⭐ 34,667 | 🐛 586 | 🌐 Python | 📅 2026-07-24 `[ObjDet]` `[ObjSeg]` Facebook FAIR's next-generation platform for object detection, segmentation, and other visual recognition tasks.
* [openpose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,363 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 `[PosEst]` Real-time multi-person keypoint detection for body, face, hands, and feet.
...
* [pytorch-lightning](https://github.com/PyTorchLightning/pytorch-lightning) ⭐ 31,289 | 🐛 1,067 | 🌐 Python | 📅 2026-08-09 `[GenLib]` Lightweight PyTorch wrapper for high-performance AI research.
* [EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,907 | 🐛 530 | 🌐 Python | 📅 2025-12-05 `[OCR]` Ready-to-use OCR supporting 80+ languages and all popular writing scripts.
...
* [SHAP](https://github.com/shap/shap) ⭐ 25,684 | 🐛 1,015 | 🌐 Jupyter Notebook | 📅 2026-08-11 `[XAI]` Game-theoretic approach to explain the output of any machine learning model.
* [vit-pytorch](https://github.com/lucidrains/vit-pytorch) ⭐ 25,485 | 🐛 141 | 🌐 Python | 📅 2026-08-02 `[ObjCls]` SOTA implementations of vision transformers in PyTorch.
* [pytorch\_geometric](https://github.com/pyg-team/pytorch_geometric) ⭐ 24,010 | 🐛 1,306 | 🌐 Python | 📅 2026-07-31 `[GenLib]` Graph Neural Network Library for PyTorch.
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,696 | 🐛 1,215 | 🌐 C++ | 📅 2026-08-13 `[GenLib]` Tencent's high-performance neural network inference framework optimized for mobile platforms.
...
* [pytorch-grad-cam](https://github.com/jacobgil/pytorch-grad-cam) ⭐ 12,955 | 🐛 160 | 🌐 Python | 📅 2026-08-13 `[XAI]` Advanced AI explainability for computer vision in PyTorch.
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection) ⭐ 12,776 | 🐛 56 | 🌐 C++ | 📅 2026-06-28 `[ObjDet]` Open source library for face detection in images, achieving \~1000FPS.
* [segmentation\_models.pytorch](https://github.com/qubvel/segmentation_models.pytorch) ⭐ 11,691 | 🐛 81 | 🌐 Python | 📅 2026-08-14 `[ObjSeg]` PyTorch segmentation models with pretrained backbones.
* [kornia](https://github.com/kornia/kornia) ⭐ 11,316 | 🐛 77 | 🌐 Python | 📅 2026-08-11 `[GenLib]` Open source differentiable computer vision library.
...
* [ORB\_SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,209 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `[SLAM]` Real-time SLAM for monocular, stereo and RGB-D cameras with loop detection and relocalization.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,914 | 🐛 868 | 🌐 Python | 📅 2024-08-13 `[ObjSeg]` OpenMMLab's semantic segmentation toolbox and benchmark.
* [computervision-recipes](https://github.com/microsoft/computervision-recipes) ⭐ 9,878 | 🐛 112 | 🌐 Jupyter Notebook | 📅 2024-02-16 `[GenLib]` Microsoft's best practices, code samples, and documentation for Computer Vision.
...
* [MONAI](https://github.com/Project-MONAI/MONAI) ⭐ 8,597 | 🐛 532 | 🌐 Python | 📅 2026-08-14 `[GenLib]` PyTorch-based, open-source framework for deep learning in healthcare imaging.
* [imagen-pytorch](https://github.com/lucidrains/imagen-pytorch) ⭐ 8,420 | 🐛 103 | 🌐 Python | 📅 2024-10-07 `[TexImg]` PyTorch implementation of Google's Imagen text-to-image neural network.
...
* [Captum](https://github.com/pytorch/captum) ⭐ 5,686 | 🐛 67 | 🌐 Python | 📅 2026-08-13 `[XAI]` PyTorch team's library for model interpretability and understanding.
...
* [SAHI](https://github.com/obss/sahi) ⭐ 5,463 | 🐛 4 | 🌐 Python | 📅 2026-08-07 `[ObjDet]` `[ObjSeg]` Lightweight vision library for large-scale object detection and instance segmentation.
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,774 | 🐛 188 | 🌐 Python | 📅 2026-08-13 `[GenLib]` PyTorch's high-level library to help with training and evaluating neural networks flexibly and transparently.
...
* [VTK](https://github.com/Kitware/VTK) ⭐ 3,190 | 🐛 0 | 🌐 C++ | 📅 2026-08-14 `[GenLib]` Open-source software system for image processing, 3D graphics, volume rendering and visualization.
...
* [PsychoPy](https://github.com/psychopy/psychopy) ⭐ 2,064 | 🐛 187 | 🌐 Python | 📅 2026-08-13 `[EyeTrk]` Library for running psychology and neuroscience experiments.
* [fastdup](https://github.com/visual-layer/fastdup) ⭐ 1,899 | 🐛 34 | 🌐 Python | 📅 2026-04-14 `[NvlDet]` `[CBIR]` Unsupervised and free tool for image and video dataset analysis.
...
* [ITK](https://github.com/InsightSoftwareConsortium/ITK) ⭐ 1,643 | 🐛 332 | 🌐 C++ | 📅 2026-08-14 `[GenLib]` Open-source, cross-platform toolkit for N-dimensional scientific image processing, segmentation, and registration.
...
* [the-incredible-pytorch](https://github.com/ritchieng/the-incredible-pytorch) ⭐ 12,619 | 🐛 3 | 📅 2026-07-22, Curated list of tutorials, papers, projects, communities and more relating to PyTorch
